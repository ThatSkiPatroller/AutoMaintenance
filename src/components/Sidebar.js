    ...
    <div>
      ...
      <nav className={`${classes.sidenav} ${classes.toggle}`}>
        ...
        {currentUser ? (
          <ul>
            <li>
              <NavLink to="/dealerList" className={classes.navlink} activeClassName={classes.active}>
                Dealers
              </NavLink>
            </li>
            <li>
            ...
            <li>
              <NavLink to="/addcar" className={classes.navlink} activeClassName={classes.active}>
                Add Vehicle
              </NavLink>
            </li>
            <li>
        ...
        <footer className={classes.social}>
          <SocialIcons />
          <p>&copy;2020, Auto Maintainance Shop</p>
        </footer>
      </nav>
    </div>
  );
