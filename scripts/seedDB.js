...
// // will have to create seeds for healthLog, Dealers, clinics, prescriptions (and appointments?)
// const healthLogSeed = [
//   {
//     date: '10/20/2017',
//     Dealer: 'Kristin King',
...
//     notes: 'Having issues with new meds, so the prescription was changed. Sick a lot - suggests follow up with respiratory Dealer asap. Weight should be monitored.',
//     nextAppt: '3 months',
//     heightIn: 50,
//     weightLb: 55,
//   },
...
//     clinic: 'Childrens Respiratory',
//     visitPurpose: '3 month follow up',
//     notes: 'Been sick every month, asthma plan not working. Need to do more with allergy Dealer if everything is starting with her nose. And check in with ENT to see if there is anything else that could be causing this',
//     nextAppt: '3 months',
//     heightIn: 50,
//     weightLb: 55,
//   },
...
//     Dealer: 'Sam Sneezy',
//     clinic: 'Allergy MN',
//     visitPurpose: 'Allergy testing, new Dealer visit',
...
//   {
//     date: '11/15/2017',
//     Dealer: 'Sally Stomach',
//     clinic: 'Gastro MN',
//     visitPurpose: '3 month follow up',
//     notes: 'Dealer not happy with previous labs, want to do endoscopy to check for issues. Explained ENT wants to do surgery, need to get them to do together so less issue with anesthesia. They will call me with date/time. Changed prescription to 10mls twice daily.',
//     nextAppt: '3 months',
//     heightIn: 50,
//     weightLb: 52,
//   },
...
const prescriptionSeed = [
  {
    ...
    Dealerprescibed: 'Dr. Kristin King',
  ...
  },
  {
    ...
    timesaday: 1,
    dateprescribed: '10/16/17',
    Dealerprescibed: 'Dr. Larry Lungs',
...
// db.Dealer
//   .remove({})
//   .then(() => db.Dealer.collection.insertMany(DealerSeed))
//   .then((data) => {
//     console.log(data.insertedIds.length + ' Dealers inserted!');
//     process.exit(0);
//   })
//   .catch((err) => {
//     console.error(err);
